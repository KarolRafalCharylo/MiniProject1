...
def move_group_python_interface_tutorial():
  ...
  #global messagerecived
  #while not messagerecived: print(messagerecived)
  rospy.sleep(3.)
  print(mymessage.pose[3])
  ...
  pose_goal.position.x = mymessage.pose[3].position.x
  pose_goal.position.y = mymessage.pose[3].position.y
  ...
  ## second movement
  pose_goal = group.get_current_pose().pose
  pose_goal.position.x =0.174062
  pose_goal.position.y =0.089097
